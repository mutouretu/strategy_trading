"""Keep one fixed-range grid-rule instance active."""
...
class FixedGridStrategyConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if self.rule.move_grid:
            raise ValueError("fixed grid strategy requires move_grid=False")


class FixedGridStrategy:
    """Deploy one bounded grid at startup without following the market."""
